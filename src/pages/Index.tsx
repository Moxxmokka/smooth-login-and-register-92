  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute -z-10 top-0 left-0 right-0 bottom-0 overflow-hidden">
        ...
        <div className="absolute w-[400px] h-[400px] rounded-full bg-form-accent blur-3xl opacity-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
      </div>
      
      <div className="mb-12 text-center">
        <h1 className="text-4xl font-bold mb-2 text-gray-900">
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-form-DEFAULT to-form-DEFAULT">
            Elegant
          </span> Auth
        </h1>
